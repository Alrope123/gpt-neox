...
taskset -c 0-3 python tools/preprocess_data.py --input c4-train --input-range 0-93 --tokenizer-type GPT2BPETokenizer  --output-prefix data/tokenized_data --num-docs 32424847 --workers 4 &> logs/0-91.txt
taskset -c 4-7 python tools/preprocess_data.py --input c4-train --input-range 91-186 --tokenizer-type GPT2BPETokenizer  --output-prefix data/tokenized_data --num-docs 32424847 --workers 4 &> logs/91-186.txt
